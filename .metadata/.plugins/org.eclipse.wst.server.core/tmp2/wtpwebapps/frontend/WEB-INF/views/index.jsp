...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="resources/images/carousal.jpg" alt="Chania" width="1000">
      </div>

      <div class="item">
        <img src="resources/images/carosal2.jpg" alt="Chania" width="1000">
      </div>
    
      <div class="item">
        <img src="resources/images/carouasl3.jpg" alt="Flower" width="1000">
      </div>

      <div class="item">
        <img src="resources/images/carousal1.jpg" alt="Flower" width="1000">
      </div>

       <div class="item">
        <img src="resources/images/carosal4.jpg" alt="Flower" width="1000">
      </div>
</div>
</div>
</br>
...
<div class="row">
  <div class="col-md-4">
    <div class="circle">
      <a href="propage">
        <img src="resources/images/images (6).jpg" class="img-circle"  alt="Cinque Terre" width="304" height="240">
        <div class="caption">
        </div>
      </a>
    </div>
  ...
  <div class="col-md-4">
    <div class="circle">
      <a href="propage">
        <img src="resources/images/IMG-3.jpg" class="img-circle"  alt="Cinque Terre" width="304" height="240">
        <div class="caption">
        </div>
      </a>
    </div>
  ...
  <div class="col-md-4">
    <div class="circle">
      <a href="propage">
        <img src="resources/images/IMG4.jpg" class="img-circle"  alt="Cinque Terre" width="304" height="240">
        <div class="caption">
        </div>
      </a>
    </div>
